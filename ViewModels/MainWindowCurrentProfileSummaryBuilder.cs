...
internal static class MainWindowCurrentProfileSummaryBuilder
{
        ...
        IReadOnlyList<CurrentProfilePointInput> points)
    {
        ...
        return $"Профиль включён: {orderedPoints.Count} точек, глубины {minDepth:0.##}–{maxDepth:0.##} м, max |Uгор|={maxSpeed:0.###} м/с. Сила течения на линии интегрируется по интерполированным сегментам ≤0.20 м; для буя, соединителей и приборов используется max |Uгор|.";
    }
}
