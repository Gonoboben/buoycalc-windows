...
Require-Contains $pdf "Build(string filePath, ApplicationRunReportReadModel report)"
Require-Contains $pdf "BuildPreflightPhysicalRejection(filePath, rejected)"
Require-Contains $workflow "CanExport(ApplicationRunReportReadModel? report)"
Require-Contains $main "CanExport(viewModel.ApplicationRunReport)"
Require-Contains $main "PdfReportBuilder.Build(path, viewModel.ApplicationRunReport!)"
