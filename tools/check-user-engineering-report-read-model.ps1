...
Require-Contains $readModel "UserEngineeringPhysicalDispositionReadModel"
Require-Contains $readModel "snapshot.PhysicalDisposition"
Require-Contains $readModel "ProjectPhysicalDisposition"
