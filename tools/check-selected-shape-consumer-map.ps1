...
Assert-Contains $marker "Services\\PdfReportBuilder.cs:92: var selectedShape = SelectedShapeStore.Current;" "Selected shape consumer map"
Assert-Contains $marker "Views\\Mooring2DCanvas.cs:67: var selectedShape = SelectedShapeStore.Current;" "Selected shape consumer map"
