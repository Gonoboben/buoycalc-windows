...
Assert-Contains $pdfReportBuilder "var nodes = shape.Nodes.Select" "PdfReportBuilder"
Assert-Contains $pdfReportBuilder "shape.HorizontalOffsetM" "PdfReportBuilder"
Assert-Contains $pdfReportBuilder "масштаб X=Z" "PdfReportBuilder"
Assert-NotContains $pdfReportBuilder "AlternativeShapeDiagram" "PdfReportBuilder"
Assert-NotContains $pdfReportBuilder "diagramSource.AlternativeShape" "PdfReportBuilder"
Assert-NotContains $pdfReportBuilder "diagramSource.HasAlternativeShape" "PdfReportBuilder"
...
Assert-NotContains $pdfDiagramSourceSelector "DiscreteHorizontalOffsetM" "PdfDiagramSourceSelector"
Assert-NotContains $pdfDiagramSourceSelector "Расчётная форма постановки X/Z" "PdfDiagramSourceSelector"
Assert-NotContains $pdfDiagramSourceSelector "Расчётные узлы линии X/Z" "PdfDiagramSourceSelector"
