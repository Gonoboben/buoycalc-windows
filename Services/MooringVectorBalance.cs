...
public static class MooringVectorBalance
{
    ...
    public static MooringVectorBalanceResult Build(CalculationResult result)
    {
        ...
        return new MooringVectorBalanceResult(
            ...
            anchorReserve,
            IsSolved: false,
            MethodNote: "Силовые члены собраны в единую векторную ведомость. Реакции вычислены как требуемые для замыкания ΣF=0, но не найдены итерационным solver равновесной формы.");
    }
}
